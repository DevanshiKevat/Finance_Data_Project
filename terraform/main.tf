...
resource "snowflake_table" "dim_date" {
  ...
  column { name = "month_name";  type = "VARCHAR" }
  column { name = "day";         type = "NUMBER" }
  column { name = "day_of_week"; type = "NUMBER" }
  column { name = "day_name";    type = "VARCHAR" }
...
resource "snowflake_table" "dim_region" {
  ...
  column { name = "regional_manager"; type = "VARCHAR" }
  column { name = "states_covered";   type = "VARCHAR" }
}
...
resource "snowflake_table" "dim_location" {
  ...
  column { name = "region_key";    type = "NUMBER" }
  column { name = "manager_name";  type = "VARCHAR" }
}
...
resource "snowflake_table" "dim_employee" {
  ...
  column { name = "location_key";      type = "NUMBER" }
  column { name = "reporting_manager"; type = "VARCHAR" }
...
resource "snowflake_table" "dim_products" {
  ...
  column { name = "hsn_code";         type = "VARCHAR" }
  column { name = "gst_rate_percent"; type = "FLOAT" }
...
resource "snowflake_table" "dim_customers" {
  ...
  column { name = "payment_habit";     type = "VARCHAR" }
  column { name = "bulk_preference";   type = "VARCHAR" }
  column { name = "loyalty_tier";      type = "VARCHAR" }
  column { name = "business_category"; type = "VARCHAR" }
  column { name = "churn_risk";        type = "FLOAT" }
  column { name = "credit_score";      type = "NUMBER" }
}
...
resource "snowflake_table" "dim_store" {
  ...
  column { name = "location_key";        type = "NUMBER" }
  column { name = "gst_registration_no"; type = "VARCHAR" }
  column { name = "opening_date";        type = "DATE" }
  column { name = "closing_date";        type = "DATE" }
  column { name = "store_manager";       type = "VARCHAR" }
}
...
resource "snowflake_table" "credit_policy" {
  ...
  column { name = "applicable_customer_type";  type = "VARCHAR" }
...
resource "snowflake_table" "customer_credit_mapping" {
  ...
  column { name = "customer_key";        type = "NUMBER" }
  column { name = "credit_policy_key";   type = "NUMBER" }
  column { name = "approval_status";     type = "VARCHAR" }
...
resource "snowflake_table" "fact_invoice_header" {
  ...
  column { name = "invoice_date_key";               type = "NUMBER" }
  column { name = "due_date";                       type = "DATE" }
  column { name = "due_date_key";                   type = "NUMBER" }
  column { name = "payment_habit";                  type = "VARCHAR" }
  column { name = "total_taxable_amount";           type = "FLOAT" }
  column { name = "total_cgst_amount";              type = "FLOAT" }
  column { name = "total_sgst_amount";              type = "FLOAT" }
  column { name = "total_igst_amount";              type = "FLOAT" }
  column { name = "total_tax_amount";               type = "FLOAT" }
  column { name = "total_gross_amount";             type = "FLOAT" }
  column { name = "total_discount_amount";          type = "FLOAT" }
  column { name = "discount_percentage";            type = "FLOAT" }
  column { name = "total_invoice_amount_incl_gst";  type = "FLOAT" }
  column { name = "net_payment";                    type = "FLOAT" }
  column { name = "invoice_status";                 type = "VARCHAR" }
  column { name = "payment_status";                 type = "VARCHAR" }
  column { name = "customer_gst_number";            type = "VARCHAR" }
  column { name = "location_key";                   type = "NUMBER" }
  column { name = "store_state";                    type = "VARCHAR" }
  column { name = "user_key";                       type = "NUMBER" }
  column { name = "store_key";                      type = "NUMBER" }
  column { name = "is_interstate";                  type = "BOOLEAN" }
}
...
resource "snowflake_table" "fact_invoice_line_item" {
  ...
  column { name = "invoice_line_key";    type = "NUMBER" }
  column { name = "invoice_key";         type = "NUMBER" }
  column { name = "product_key";         type = "NUMBER" }
  column { name = "quantity";            type = "NUMBER" }
  column { name = "unit_price_excl_gst"; type = "FLOAT" }
  column { name = "gross_line_amount";   type = "FLOAT" }
  column { name = "discount_percent";    type = "FLOAT" }
  column { name = "discount_amount";     type = "FLOAT" }
  column { name = "taxable_amount";      type = "FLOAT" }
  column { name = "cgst_percent";        type = "FLOAT" }
  column { name = "sgst_percent";        type = "FLOAT" }
  column { name = "igst_percent";        type = "FLOAT" }
  column { name = "cgst_amount";         type = "FLOAT" }
  column { name = "sgst_amount";         type = "FLOAT" }
  column { name = "igst_amount";         type = "FLOAT" }
  column { name = "total_tax_amount";    type = "FLOAT" }
  column { name = "line_total_incl_gst"; type = "FLOAT" }
}
...
resource "snowflake_table" "fact_payment_b2b_b2d" {
  ...
  column { name = "payment_date_key";        type = "NUMBER" }
  column { name = "payment_amount";          type = "FLOAT" }
  column { name = "payment_mode";            type = "VARCHAR" }
  column { name = "bank_reference_number";   type = "VARCHAR" }
  column { name = "settlement_status";       type = "VARCHAR" }
  column { name = "channel_type";            type = "VARCHAR" }
  column { name = "is_refund";               type = "BOOLEAN" }
  column { name = "remarks";                 type = "VARCHAR" }
  column { name = "enterprise_payment_key";  type = "NUMBER" }
}
...
resource "snowflake_table" "fact_payment_b2c" {
  ...
  column { name = "is_refund";             type = "BOOLEAN" }
  column { name = "remarks";               type = "VARCHAR" }
  column { name = "retail_payment_key";    type = "NUMBER" }
  column { name = "store_key";             type = "NUMBER" }
  column { name = "store_id";              type = "VARCHAR" }
}
...
resource "snowflake_table" "fact_returns" {
  ...
  column { name = "return_id";              type = "VARCHAR" }
  column { name = "invoice_key";            type = "NUMBER" }
  column { name = "invoice_id";             type = "VARCHAR" }
  column { name = "customer_key";           type = "NUMBER" }
  column { name = "product_key";            type = "NUMBER" }
  column { name = "return_quantity";        type = "NUMBER" }
  column { name = "original_quantity";      type = "NUMBER" }
  column { name = "refund_amount";          type = "FLOAT" }
  column { name = "refund_tax_amount";      type = "FLOAT" }
  column { name = "total_refund_amount";    type = "FLOAT" }
  column { name = "return_date_key";        type = "NUMBER" }
  column { name = "return_date";            type = "DATE" }
  column { name = "refund_date_key";        type = "NUMBER" }
  column { name = "refund_date";            type = "DATE" }
  column { name = "return_reason_category"; type = "VARCHAR" }
  column { name = "return_reason_detail";   type = "VARCHAR" }
  column { name = "return_channel";         type = "VARCHAR" }
  column { name = "refund_type";            type = "VARCHAR" }
  column { name = "restocking_fee_percent"; type = "FLOAT" }
  column { name = "restocking_fee_amount";  type = "FLOAT" }
  column { name = "net_refund_amount";      type = "FLOAT" }
  column { name = "approved_by_user_key";   type = "NUMBER" }
  column { name = "approved_by_name";       type = "VARCHAR" }
  column { name = "status";                 type = "VARCHAR" }
